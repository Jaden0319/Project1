  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  27:	e8 1f 03 00 00       	call   34b <exit2>
}
 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 3d6:	50                   	push   %eax
 3d7:	56                   	push   %esi
 3d8:	e8 d6 fe ff ff       	call   2b3 <write>
  while(--i >= 0)
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 440:	50                   	push   %eax
 441:	57                   	push   %edi
 442:	e8 6c fe ff ff       	call   2b3 <write>
 ...
 4b1:	52                   	push   %edx
 4b2:	57                   	push   %edi
 4b3:	e8 fb fd ff ff       	call   2b3 <write>
        putc(fd, c);
 ...
 5b1:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 627:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62a:	89 15 70 0a 00 00    	mov    %edx,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 70 0a 00 00    	mov    0xa70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 691:	75 ed                	jne    680 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 693:	83 ec 0c             	sub    $0xc,%esp
 696:	56                   	push   %esi
 697:	e8 7f fc ff ff       	call   31b <sbrk>
  if(p == (char*)-1)
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 74 0a 00 00       	mov    $0xa74,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 710:	00 00 00 
    if(p->s.size >= nunits){
